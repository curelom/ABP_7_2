...
public class ABP_7_2DomainModule : AbpModule
{
        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<ABP_7_2Resource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<ABP_7_2Resource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
